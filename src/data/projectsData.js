const projectsData = [
  {
    ...
    longDescription: "Marketing website for a local marine repair company.",
  },
  {
    id: 2,
    name: "CarAmerican",
  ...
  },
  {
    ...
    description:
      "Application allows for users to sign up either as a student or tutor. Students choose a tutor based on the programming language they teach and availability with a calendar.",
    longDescription:
